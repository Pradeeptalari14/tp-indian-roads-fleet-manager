# 🚚 Agentic Fleet Manager for Indian Roads

> Route optimizer parsing traffic maps. Triggers warning webhook pings on routing alerts.
...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/indian-roads-fleet-manager/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-indian-roads-fleet-manager.git
cd tp-indian-roads-fleet-manager
```
...
```bash
kubectl port-forward deployment/tp-indian-roads-fleet-manager 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── fleet_manager.py     # Main configuration file
```
...
---
*Generated by [Agentic Fleet Manager for Indian Roads Studio](https://pradeeptalari14.github.io/portfolio/tools/indian-roads-fleet-manager/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
